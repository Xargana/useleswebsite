...
<head>
    ...
    <link rel="icon" type="image/png" sizes="32x32" href="../plugins/images/icon.png">
...
<body>
    ...
    <div id="wrapper">
            ...
            <button class="btn btn-default" type="button"> <i class="fa fa-search"></i> </button>
                   ...
                   <li> <a href="#" class="waves-effect"><i data-icon="&#xe00b;" class="linea-icon linea-basic fa-fw"></i> <span class="hide-menu">Blog<span class="fa arrow"></span></span></a>
                        <ul class="nav nav-second-level">
                            ...
                            <li><a href="new-post.php">Add New Game</a></li>
        ...
        <div id="page-wrapper">
                ...
                <div class="row">
                    ...
                    <div class="col-sm-12">
                        <div class="white-box">
                        		...
                        		<?php
									if (isset($_GET["success"])) {
										...
										'<div class="alert alert-success" >
					                         ...
					                         <strong>DONE!! </strong><p> The new WraithMeta Administrator has been added. They can now log in to their account with their credentials.</p>
					                    </div>'
										;
									}
                            ...
                            <h3 class="box-title m-b-0">WraithMeta Administrators ( <x style="color: orange;"><?php echo mysqli_num_rows($query);?></x> )</h3>
            ...
            <!-- /.container-fluid -->
            <footer class="footer text-center"> 2021 &copy; WraithMeta </footer>
        </div>
        <!-- /#page-wrapper -->
    </div>
    <!-- /#wrapper -->
